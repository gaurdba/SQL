...
--
set lines 300
col TABLE_AND_INDEX_NAME for a30
col INDEX_TYPE for a13
col LAST_ANALYZED for a25
col Operation for a35
col "Timed event" for a30
col ORIGIN for a25
col ET_SECS_PER_EXEC for a15
col CPU_SECS_PER_EXEC for a15
col ROWS_PER_EXEC for a15
col ET_SECS_TOT for a15 
col ROWS_PER_EXEC for a15
col "Current object" for a25
col "Timed event" for a45
col CPU_SECS_TOT  for a12
...
COL current_object_ff               FOR A50 HEA "Current object";
...
COL timed_event_ff                  FOR A40 HEA "Timed event";
...
PRO
PRO Commented DBA_HIST_SQLSTAT TOTAL (ordered by snap_id DESC, instance_number and plan_hash_value)
PRO ~~~~~~~~~~~~~~~~~~~~~~
 SPO planx_&&sql_id._&&current_time..txt APP;
SELECT   s.snap_id
       , TO_CHAR(s.begin_interval_time, 'YYYY-MM-DD"T"HH24:MI:SS') begin_interval_time_ff
...
*/
PRO
PRO SKIP DBA_HIST_SQLSTAT DELTA (ordered by et_secs_per_exec)
PRO ~~~~~~~~~~~~~~~~~~~~~~
SELECT   plan_hash_value
