...
declare
        ...
        l_operation             aab_rman.rc_rman_backup_subjob_details.operation%type;
        ...
        where bjd.db_name!='S1TEST' and end_time > sysdate - &Enter_number_Of_days and (status like '%FAIL%' or status like '%WARNING%' or status like '%RUNNING%' or status like '%ERRORS%')
